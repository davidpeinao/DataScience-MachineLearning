...
#
#
#       MUJERES ENTRE 20 Y 50 AÑOS(AMBOS INCLUIDOS)
#       
#
#
#       VARIABLES USADAS: NUMERO DE HIJOS, ESTADO CIVIL, NUMERO DE GENERACIONES EN EL HOGAR, 
...
subset = subset.loc[censo['EDAD']>=20]
subset = subset.loc[censo['EDAD']<=50]               
#seleccionar variables de interés para clustering
usadas = ['NHIJOS', 'ECIVIL', 'NGENER', 'NMIEM']
X = subset[usadas]
print(X.shape) # numero de instancias antes del sample
